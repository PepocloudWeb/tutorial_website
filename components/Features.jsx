    ...
    <div className="container">
        ...
        <div className="w-full px-4">
          <div className="mb-12 max-w-[620px] lg:mb-20">
            ...
            <h2 className="mb-4 text-3xl font-bold text-dark sm:text-4xl md:text-[42px]">
              Main Features Of Sample
            </h2>
            <p className="text-lg leading-relaxed text-body-color sm:text-xl sm:leading-relaxed">
              Boost your Team’s productivity with these state-of-the-art
              features
            </p>
          </div>
        </div>
      ...
      <div className="-mx-4 flex flex-wrap">
        <div className="w-full px-4 md:w-1/2 lg:w-1/4">
          <div
            className="wow fadeInUp group mb-12 bg-white rounded-3xl p-5 shadow-lg"
            data-wow-delay=".1s"
          >
            ...
            <p className="mb-8 text-body-color lg:mb-11">
              Record quick videos of your screen/camera just with a click. No
              need to mess around with any settings. Everything is pre-defined.
            </p>
            <Link
              href="javascript:void(0)"
              className="text-base font-medium text-body-color hover:text-primary hidden"
            >
              Learn More
            </Link>
          </div>
        ...
        <div className="w-full px-4 md:w-1/2 lg:w-1/4">
          ...
          >
            ...
            <p className="mb-8 text-body-color lg:mb-11">
              Get a link of your video instantaneously so you can share it with
              anyone you like. Your recipient can watch the video without
        ...
        <div className="w-full px-4 md:w-1/2 lg:w-1/4">
          ...
          >
            ...
            <p className="mb-8 text-body-color lg:mb-11">
              With our advanced technology on your side, you will get a crystal
              clear video. All the settings are pre-coded to achieve the maximum
              quality video.
            </p>
            <Link
              href="javascript:void(0)"
        ...
        <div className="w-full px-4 md:w-1/2 lg:w-1/4">
          ...
          >
            ...
            <p className="mb-8 text-body-color lg:mb-11">
              Sample runs on our cloud. So, you don&apos;t have to install any
              software to record a video. No processing or wait time either.
            </p>
            <Link
              href="/"
              className="text-base font-medium text-body-color hover:text-primary hidden"
