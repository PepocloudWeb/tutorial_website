...
import heroLogos from "../public/hero/brand.svg";
        ...
        <div className="-mx-4 flex flex-wrap items-center">
          <div className="w-full px-4">
            <div
              ...
              data-wow-delay=".2s"
            >
              <h1 className="mb-8 text-3xl font-bold leading-snug text-white sm:text-4xl sm:leading-snug md:text-[45px] md:leading-snug md:min-w-[780px] mx-auto capitalize">
                Cloud-based simple intuitive platform for video/screen recording
              </h1>
              <p className="mx-auto mb-10 max-w-[600px] text-base text-[#e4e4e4] sm:text-lg sm:leading-relaxed md:text-xl md:leading-relaxed md:min-w-[780px]">
                Record your camera or screen and share them immediately with
                others with a click of a button. Easily invite others and record
              ...
              <ul className="mb-10 flex flex-wrap items-center justify-center">
                <li>
                  ...
                  <p className="text-dimWhite mt-1">No credit card required.</p>
                </li>
                <li>
                  <Link
              ...
              <div className="wow fadeInUp text-center" data-wow-delay=".3s">
                <Image
                  src={heroLogos}
                  alt="image"
                  className="mx-auto px-10 w-full max-w-[700px] opacity-70 transition duration-300 ease-in-out hover:opacity-100"
                />
              </div>
              <Stats />
            </div>
          ...
          <div className="w-full px-4">
            <div
              className="wow fadeInUp relative z-10 mx-auto max-w-[700px]"
              data-wow-delay=".25s"
            >
              <div className="mt-16 border-2 border-dimWhite rounded-lg">
                {/* We want to show this player after the app is loaded, else it will show hydration error */}
                {domLoaded && (
                  <ReactPlayer
                    controls
                    url="https://youtu.be/nHFGyn9NH3s"
