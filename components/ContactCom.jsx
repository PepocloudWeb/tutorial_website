...
import contactpage from "../public/hero/contactpage.jpg";
      ...
      <div className="container mx-auto">
        <div className="-mx-4 flex flex-wrap lg:justify-between">
          <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
            <div className="mb-12 max-w-[570px] lg:mb-0">
              ...
              <p className="mb-9 text-base leading-relaxed text-body-color">
                We would love to hear your opinion about our product. We welcome
                both positive and negative feedback. Please feel free to leave a
                message.
              </p>
          ...
          <div className="w-full lg:w-1/2">
            <div>
              <iframe
                src="https://app.pepoform.ai/aiform/92"
                loading="lazy"
                width="950"
                height="1000"
                frameborder="0"
